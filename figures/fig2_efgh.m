...
if exist('source_data_dir','var') ~= 1
    ...
    [r_sim_a,p_sim_a] = corr(eigmax',ft_pl_sim.Alpha);
    [r_sim_t,p_sim_t] = corr(eigmax',ft_pl_sim.Tau_prime,...
        'Type','Spearman');
    [r_sim_md,p_sim_md] = corr(eigmax',cellfun(@max,dur_sim)',...
        'Type','Spearman');
    [r_sim_a_sa,p_sim_a_sa] = corr(eigavg',ft_pl_sim.Alpha);
    [r_sim_t_sa,p_sim_t_sa] = corr(eigavg',ft_pl_sim.Tau,...
        'Type','Spearman');
    [r_emp_a,p_emp_a] = corr(eigmax',ft_pl_emp.Alpha);
    [r_emp_t,p_emp_t] = corr(eigmax',ft_pl_emp.Tau_prime,...
        'Type','Spearman');
    [r_emp_md,p_emp_md] = corr(eigmax',cellfun(@max,dur_emp)',...
        'Type','Spearman');
    [r_emp_a_sa,p_emp_a_sa] = corr(eigavg',ft_pl_emp.Alpha);
    [r_emp_t_sa,p_emp_t_sa] = corr(eigavg',ft_pl_emp.Tau,...
        'Type','Spearman');
    ft_corr = table(...
            [r_sim_a r_emp_a]', [p_sim_a p_emp_a]',...
            [r_sim_t r_emp_t]', [p_sim_t p_emp_t]',...
            [r_sim_md r_emp_md]', [p_sim_md p_emp_md]',...
            [r_sim_t_sa r_emp_t_sa]', [p_sim_t_sa p_emp_t_sa]',...
        'VariableNames',{...
            'r_alpha','p_alpha',...
            'r_tau_p','p_tau_p',...
            'r_max_dur','p_max_dur',...
            'r_tau_p_sa','p_tau_p_sa'},...
        'RowNames',{'simulated','empirical'});
    clear r_* p_*
    disp(ft_corr)
end
